                  ...
                  <div className="grid grid-cols-2 w-full h-full mt-[20px]">
                    <div>
                      ...
                      <div className="flex gap-2">
                        <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.contractAddress}</h1>
                        <Books/>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.tokenId}</h1>
                    </div>

                    <div>
                      <h1 className="text-black font-Archivo text-md font-normal leading-normal tracking-wider">Token standard</h1>
                      <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.tokenStandart}</h1>
                    </div>

                    <div>
                      <h1 className="text-black font-Archivo text-md font-normal leading-normal tracking-wider">Blockchain</h1>
                      <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.blockchain}</h1>
                    </div>

                    <div>
                      <h1 className="text-black font-Archivo text-md font-normal leading-normal tracking-wider">Token supply</h1>
                      <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.totalSupply}</h1>
                    </div>

                    <div>
                      <h1 className="text-black font-Archivo text-md font-normal leading-normal tracking-wider">Creator</h1>
                      <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">{item.creator}</h1>
                    </div>
