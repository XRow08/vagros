  ...
  return (
    <div className="bg-white relative flex flex-col items-center h-[440px] w-full">
      <div className="flex flex-col w-full items-center">
        ...
        <div className="lg:absolute rounded-xl border-4 shadow-2xl border-white -mt-24 lg:-mt-0 lg:top-[200px] lg:left-[10%] w-[230px] h-[200px]">
          <img
        ...
        <div className="flex flex-col lg:mx-[calc(10%+250px)] lg:pl-[25%] w-full lg:h-[100px] lg:px-[10%] px-4">
