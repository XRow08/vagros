  ...
  return(
    <div className="flex flex-col fixed w-screen h-screen inset-0 bg-opacity-70  backdrop-filter backdrop-blur-md">
      ...
      <div className="flex flex-col items-center w-full h-full">
        <div className="flex flex-col items-center inset-1 mt-[200px] w-[490px] px-[20px] py-[30px] h-[320px] rounded-lg border-[2px] border-gray-300 bg-white text-black shadow-xl">

          <div className="flex flex-col gap-4 border-b-2 border-gray-300 pb-[20px]">

            <div className="flex items-center justify-between">
              <h1 className="text-black font-Archivo text-lg font-bold leading-normal tracking-wider">Conecte sua wallet para continuar</h1>
              <X/>
            </div>
            ...
            <div className="flex flex-col gap-4 items-center w-[90%]">
              ...
              <div className="flex flex-col items-center gap-3 w-full border-gray-300 border-2 shadow-lg rounded-lg cursor-pointer py-1">
                <div className="flex items-center">
                  <Metamask></Metamask>
                  <h1 className="text-black font-Archivo text-20 font-normal leading-normal">Conectar pela <strong>MetaMask</strong></h1>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 w-full border-gray-300 border-2 shadow-lg rounded-lg cursor-pointer py-1">
                ...
                <div className="flex items-center">
                  ...
                  <h1 className="text-black font-Archivo text-20 font-normal leading-normal">Conectar pela <strong>WalletConnect</strong></h1>
                </div>
