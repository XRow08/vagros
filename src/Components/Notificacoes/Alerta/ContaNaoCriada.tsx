...
export default function ContaNaoCriada(){
  return(
    <div className="flex items-center gap-5 bg-black bg-opacity-20 w-[400px] border-l-[3px] border-[#F00] p-2 pl-4 py-4 rounded-r-md">
      ...
      <div>
        ...
        <h1 className="text-white font-Archivo text-16 font-normal tracking-wide leading-normal letter-spacing-0.8">Não foi possível criar sua conta</h1>
      </div>
