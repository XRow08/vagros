...
export default function NftData() {
  return (
    <div className="flex flex-col w-full h-[280px] bg-white rounded-lg p-5 shadow-2xl">
          ...
          <div className="flex mt-[15px]">
            <div className="flex flex-col w-[50%]">
              <div className="flex items-center gap-2 justify-between w-full">
                <div className="flex flex-col items-center bg-white rounded-md w-[30%] h-[50px] pt-[2%] pb-[2%] bg-opacity-40 backdrop-blur-md shadow-xl">
